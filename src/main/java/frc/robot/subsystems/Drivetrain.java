...
public class Drivetrain extends SubsystemBase{
  ...
  public DifferentialDrive differentialDrive;
    ...
    rightMotorFollowerConfig
        ...
        leftMotorLeader.configure(baseConfig,com.revrobotics.spark.SparkBase.ResetMode.kResetSafeParameters, PersistMode.kNoPersistParameters);
        leftMotorFollower.configure(leftMotorFollowerConfig,com.revrobotics.spark.SparkBase.ResetMode.kResetSafeParameters, PersistMode.kNoPersistParameters);
        rightMotorLeader.configure(rightMotorLeaderConfig,com.revrobotics.spark.SparkBase.ResetMode.kResetSafeParameters, PersistMode.kNoPersistParameters);
        rightMotorFollower.configure(rightMotorFollowerConfig,com.revrobotics.spark.SparkBase.ResetMode.kResetSafeParameters, PersistMode.kNoPersistParameters);
